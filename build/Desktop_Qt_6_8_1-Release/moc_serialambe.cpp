...
namespace {
struct qt_meta_tag_ZN10SerialAMBEE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN10SerialAMBEE = QtMocHelpers::stringData(
    "SerialAMBE",
    "connected",
    "",
    "data_ready",
...
Q_CONSTINIT static const uint qt_meta_data_ZN10SerialAMBEE[] = {
...
Q_CONSTINIT const QMetaObject SerialAMBE::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN10SerialAMBEE.offsetsAndSizes,
    qt_meta_data_ZN10SerialAMBEE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN10SerialAMBEE_t,
        // Q_OBJECT / Q_GADGET
...
void SerialAMBE::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (SerialAMBE::*)(bool );
            if (_q_method_type _q_method = &SerialAMBE::connected; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (SerialAMBE::*)();
            if (_q_method_type _q_method = &SerialAMBE::data_ready; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _q_method_type = void (SerialAMBE::*)();
            if (_q_method_type _q_method = &SerialAMBE::ambedev_ready; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
void *SerialAMBE::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN10SerialAMBEE.stringdata0))
