...
namespace {
struct qt_meta_tag_ZN3YSFE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN3YSFE = QtMocHelpers::stringData(
    "YSF",
    "process_udp",
    "",
    "process_rx_data",
...
Q_CONSTINIT static const uint qt_meta_data_ZN3YSFE[] = {
...
Q_CONSTINIT const QMetaObject YSF::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN3YSFE.offsetsAndSizes,
    qt_meta_data_ZN3YSFE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN3YSFE_t,
        // Q_OBJECT / Q_GADGET
...
void *YSF::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN3YSFE.stringdata0))
